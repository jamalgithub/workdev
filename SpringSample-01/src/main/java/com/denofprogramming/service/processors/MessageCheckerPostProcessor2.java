...
public class MessageCheckerPostProcessor2 implements BeanPostProcessor, PriorityOrdered {
	...
	public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
		...
		if (bean instanceof MessageOfTheDayService) {
			...
			if (!"".equals(service.getMessage()))
				System.out.println("MessageCheckerBeanPostProcessor2-->BeforeInitialization : " + beanName
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		...
		if (bean instanceof MessageOfTheDayService) {
			final MessageOfTheDayService service = (MessageOfTheDayService) bean;
			if (!"".equals(service.getMessage()))
				System.out.println("MessageCheckerBeanPostProcessor2-->AfterInitialization : " + beanName
						+ " contains: " + service.getMessage());
		}
		return bean;
	}
