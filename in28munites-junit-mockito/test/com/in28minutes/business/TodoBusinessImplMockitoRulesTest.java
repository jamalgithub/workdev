...
public class TodoBusinessImplMockitoRulesTest {
	...
	public void captureMultiArguments() {
		...
		//verify(todoService,Mockito.times(2)).deleteTodo(stringArgumentCaptor.capture());
		then(todoService).should(Mockito.times(2)).deleteTodo(stringArgumentCaptor.capture());
