...
public class ModelAttributeDemoController {
	...
	public String home() {
		...
		return "test/modelAttributeTestViews/modelAttributeHome";
	}
	...
	public ModelAndView home2() {
		...
		mav.setViewName("test/modelAttributeTestViews/modelAttributeHome");
	...
	public ModelAndView home3() {
		...
		ModelAndView mav = new ModelAndView("test/modelAttributeTestViews/modelAttributeHome");
		mav.addObject("anAddress", new Address());
		//mav.addObject("command", new Address());
	...
	public ModelAndView home4() {
		...
		return new ModelAndView("test/modelAttributeTestViews/modelAttributeHome", "anAddress", new Address("Melbourne", "3000"));
	...
	public String modelAttributeTest5(@ModelAttribute(value="anAddress") Address anAddress, ModelMap model) {
		...
		return "test/modelAttributeTestViews/modelAttributeTest";
	}	
