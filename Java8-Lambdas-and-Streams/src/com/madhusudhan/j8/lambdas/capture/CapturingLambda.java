...
public class CapturingLambda {
	...
	public boolean isOpenTrade() {
		ITrade simpleLambda = (t) -> t.isOpen();
		return simpleLambda.check(trade);
	}

	public boolean checkStatus(String status) {
		ITrade statusLambda = (t) -> t.getStatus().equals(status);
	...
	public static void main(String[] args) {
		...
		System.out.println("status Trade using non-capturing lambda: " + cl.checkStatus("CLOSE"));
		System.out.println("is Open and status Trade using non-capturing lambda: " + cl.isOpenAndBig("OPEN", 1000));
	}
