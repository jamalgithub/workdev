...
public class PrimitiveFunctions {
	...
	// DoubleToIntFunction -- convert primitive double to primitive int --
	// applyAsInt
	// DoubleToLongFunction -- convert primitive double to primitive long --
	// applyAsLong
	// IntToDoubleFunction -- convert primitive int to primitive double --
	// applyAsDouble
	// IntToLongFunction -- convert primitive int to primitive long -- applyAsLong
	// LongToDoubleFunction -- convert primitive long to primitive double --
	// applyAsDouble
