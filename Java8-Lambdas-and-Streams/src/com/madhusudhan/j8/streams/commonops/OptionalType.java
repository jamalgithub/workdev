...
public class OptionalType {
	...
	public static void Test(Stream<Double> temperatures) {
	 ...
	 * @param temperatures
	 */
	public static void TestPrimitive(DoubleStream temperatures) {
	...
	public static void main(String[] args)  {
		...
		OptionalType.TestPrimitive(DoubleStream.of(12.0, 14.3, 2.6));
		OptionalType.Test(Stream.of(12.0, 14.3, 2.6));
